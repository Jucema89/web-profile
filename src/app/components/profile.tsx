...
export default function Profile(){
  ...
  function settingTheme(newTheme: 'ligth' | 'dark'){
    ...
    return(
        <div className="z-10 max-w-md w-full bg-white border border-gray-100 text-start rounded-xl shadow-md after:absolute after:top-0 after:-start-4 after:w-4 after:h-full dark:bg-neutral-900 dark:border-neutral-700">
