    ...
    return(
        <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
            <div className="p-4 md:p-6">
                ...
                Desarrollador FullStack orientado al detalle, con más de cinco años de experiencia 
                trabajando con JavaScript y tecnologías relacionadas. Poseo un manejo avanzado 
                del framework Angular, con énfasis en aplicaciones de gran envergadura que 
                utilizan RxJs y NgRx. Experiencia en la creación de backends con Node.js, 
